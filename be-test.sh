...
WORKMODEL="aggregator"  # Used by redeploy.sh
...
do
    ...
    do
        ...
        do
            ...
            go run . -v 2 -test --replicaCnt=$replica --strategy=be --output=$WORKDIR/${layer}_${WORKMODEL}_replica${replica}.csv >> $WORKDIR/migrator.log 2>&1
